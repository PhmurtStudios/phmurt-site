(function () {
  ...
  const BREADCRUMBS = {
    ...
    'lifetime.html': [
      ...
      { label: 'Lifetime Pass', current: true }
    ],
    'blog.html': [
      { href: 'index.html', label: 'Home' },
    ...
    'blog-welcome.html': [
      ...
      { label: 'Welcome to Phmurt Studios', current: true }
    ],
    'press.html': [
      { href: 'index.html', label: 'Home' },
      { label: 'Press Kit', current: true }
    ]
  };
  ...
  function footerMarkup() {
    return `
      <footer class="ps-footer" role="contentinfo">
        ...
        <div class="ps-footer-links" style="margin-top:0.5rem;font-size:0.85rem;opacity:0.85;text-align:center;">
          <a href="roadmap.html" style="color:inherit;text-decoration:underline;">Roadmap</a>
          <span style="margin:0 0.5rem;">|</span>
          <a href="blog.html" style="color:inherit;text-decoration:underline;">Blog</a>
          <span style="margin:0 0.5rem;">|</span>
          <a href="press.html" style="color:inherit;text-decoration:underline;">Press</a>
          <span style="margin:0 0.5rem;">|</span>
          <a href="pricing.html" style="color:inherit;text-decoration:underline;">Pricing</a>
        </div>
        <div class="ps-footer-legal" style="margin-top:0.35rem;font-size:0.85rem;opacity:0.7;text-align:center;">
          ...
          <span style="margin:0 0.5rem;">|</span>
          <a href="cookies.html" style="color:inherit;text-decoration:underline;">Cookies</a>
        </div>
      </footer>
    `;
  }
